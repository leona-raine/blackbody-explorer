...
- Build interactive visualization to use sliders, plots, and color outputs to help users intuitively explore blackbody radiation and its applications.
...
- interactive dashboard ui (temperature slider, spectrum plot dynamically updates, download csv/plot buttons).
...
- Visualization output: spectrum plots, color patch, peak wavelength, and temperature, graph annotations (λ_max, intensity, peaks).
...
# Deployment plan
- Prototyping: jupyter notebook (to visualize Planck curves and fitting results).
- Web mvp (Streamlit): Create app with sliders, upload box, and plot.
...
- Final version: Polish UI, add auto explanations, export tools, and documentation
